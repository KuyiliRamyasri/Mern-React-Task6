  ...
  return (
    <div class="App">
      ...
      <div ref={home} class="home">
        ...
        <table>
          <tr>
            <td>
              <h3 class="i1">Hi</h3>
              <h3 class="i1">I am Kuyili Ramyasri</h3>
              ...
              <h3 class="i1">
                ...
                and Cloud practitioner internship by{" "}
      ...
      <div ref={skills} class="skills">
        ...
        <h4>➢ Web technologies:Html,CSS,JavaScript.</h4>
        <h4>
          ➢ Artificial intelligence and machine learning, web
      ...
      <div ref={contact} class="contact">
        ...
        <h4>Email me at vintaramya07@gmail.com</h4>
        <h4>Contact Number 9063391334</h4>
      </div>
    </div>
  );
}
